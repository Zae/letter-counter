...
var _lettercounter = require('../../../public/assets/js/modules/lettercounter');
...
_qunitjs2.default.test("alphabet", function (assert) {
    var counted = (0, _lettercounter2.default)('abcdefghijklmnopqrstuvwxyz');

    assert.strictEqual(counted.vowels(), 5, "Passed!");
    assert.strictEqual(counted.consonants(), 21, "Passed!");
});

_qunitjs2.default.test("double-alphabet", function (assert) {
    var counted = (0, _lettercounter2.default)('abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz');

    assert.strictEqual(counted.vowels(), 10, "Passed!");
    assert.strictEqual(counted.consonants(), 42, "Passed!");
});

_qunitjs2.default.test("multi-alphabet", function (assert) {
    var counted = (0, _lettercounter2.default)('');

    assert.strictEqual(counted.vowels(), 50, "Passed!");
    assert.strictEqual(counted.consonants(), 210, "Passed!");
});

_qunitjs2.default.test("CapiTalIZatioN", function (assert) {
    var counted = (0, _lettercounter2.default)('aBcDEfGHiJkLmNOpqRsTuVWxYz');
...
_qunitjs2.default.test("Strange Characters", function (assert) {
    var counted = (0, _lettercounter2.default)('aBc%DE!fGH%iJk^Lm*N%OpqR(sTu%^VW(xYz');

    assert.strictEqual(counted.vowels(), 5, "Passed!");
    assert.strictEqual(counted.consonants(), 21, "Passed!");
});

_qunitjs2.default.test("Top3", function (assert) {
    var counted = (0, _lettercounter2.default)('eeeeeeeeeeuuuuuiiiooakkkkkkkkkkttttthhhqqz');
...
_qunitjs2.default.test("Top3 - Strange Characters", function (assert) {
    var counted = (0, _lettercounter2.default)('eeee*e)eee%eeuuuu^u$iiioo_akk#kkkk*kkkk!tttt+th(hhqqz');

    assert.deepEqual(counted.vowelsTop3(), [{ letter: 'e', occurrences: 10 }, { letter: 'u', occurrences: 5 }, { letter: 'i', occurrences: 3 }], "Passed!");
    assert.deepEqual(counted.consonantsTop3(), [{ letter: 'k', occurrences: 10 }, { letter: 't', occurrences: 5 }, { letter: 'h', occurrences: 3 }], "Passed!");
});

},{"../../../public/assets/js/modules/lettercounter":3,"qunitjs":2}]},{},[4])
